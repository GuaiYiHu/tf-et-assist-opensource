...
def pose_gen_mask(meta):
    # cv2.imshow('org', meta.img)
    # plt.imshow(meta.img)
    # plt.show()
    miss_mask = meta.miss_mask.astype(np.uint8)
    meta.img = meta.img * miss_mask
    # plt.imshow(meta.img)
    # plt.show()
    # plt.pause(0.01)
    # cv2.imshow('masked', meta.img)
    # cv2.waitKey(0)
    return meta
