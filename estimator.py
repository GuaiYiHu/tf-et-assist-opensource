...
class TfPoseEstimator:
    ...
    def draw_humans(npimg, humans, imgcopy=False):
        ...
        for human in humans:
            # draw point
            for i in range(common.CrossPartCocoPoseTrack.Background.value):
                ...
                # cv2.circle(npimg, center, 3, common.CocoColors[12], thickness=3, lineType=8, shift=0)
            ...
            for pair_order, pair in enumerate(common.CocoPairsRender):
                ...
                # cv2.line(npimg, centers[pair[0]], centers[pair[1]], common.CocoColors[12], 3)
